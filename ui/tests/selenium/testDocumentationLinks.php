...
class testDocumentationLinks extends CWebTest {
	...
	public static function getGeneralDocumentationLinkData() {
		return [
			...
			[
				[
					'url' => 'sdnet.php?action=search&search=zabbix',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=acknowledge.edit&eventids%5B0%5D=93',
					'doc_link' => '/en/manual/acknowledgment#updating-problems'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=host.view',
			...
			[
				[
					'url' => 'sdnet.php?action=host.dashboard.view&hostid=10084',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=service.edit',
					'doc_link' => '/en/manual/web_interface/frontend_sections/services/service#editing-services'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&eventsource=4',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=sla.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=scheduledreport.list',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=hostgroup.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=hostgroup.edit&groupid=4', // Zabbix servers.
					'doc_link' => '/en/manual/config/hosts/host#creating-a-host-group'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=template.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=template.edit&templateid=10076', // AIX by Zabbix agent.
					'doc_link' => '/en/manual/config/templates/template#creating-a-template'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=item.list&filter_set=1&filter_hostids[0]=15000&context=template',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=item.edit&hostid=10076&context=template', // AIX by Zabbix agent.
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=item.edit&context=template&itemid=22933', // Host name (AIX by Zabbix agent).
					'doc_link' => '/en/manual/config/items/item#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=trigger.list&context=template',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=trigger.edit&context=template',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=trigger.edit&triggerid=13367&hostid=10076&context=template',
					'doc_link' => '/en/manual/config/triggers/trigger#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=trigger.list&filter_set=1&filter_hostids%5B0%5D=15000&context=template',
					'actions' => [
						[
							'callback' => 'openMassUpdate'
						]
			...
			[
				[
					'url' => 'sdnet.php?action=graph.list&context=template',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.edit&context=template&hostid=15000',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.edit&context=template&graphid=15000',
					'doc_link' => '/en/manual/config/visualization/graphs/custom#configuring-custom-graphs'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=template.dashboard.list&templateid=10076&context=template',
					'doc_link' => '/en/manual/web_interface/frontend_sections/monitoring/hosts/dashboards'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=template.dashboard.edit&dashboardid=50',
					'doc_link' => '/en/manual/web_interface/frontend_sections/dashboards#creating-a-dashboard'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=item.prototype.list&parent_discoveryid=15011&filter_set=1&context=template',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=item.prototype.edit&context=template&parent_discoveryid=66316',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=item.prototype.edit&itemid=66319&parent_discoveryid=66316&context=template',
					'doc_link' => '/en/manual/discovery/low_level_discovery/item_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=trigger.prototype.list&parent_discoveryid=15011&context=template',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=trigger.prototype.edit&parent_discoveryid=66316&context=template',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=trigger.prototype.edit&parent_discoveryid=66316&triggerid=31082&context=template',
					'doc_link' => '/en/manual/discovery/low_level_discovery/trigger_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=graph.prototype.list&parent_discoveryid=15011&context=template',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.prototype.edit&context=template&parent_discoveryid=15011',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.prototype.edit&context=template&parent_discoveryid=15011&graphid=15008',
					'doc_link' => '/en/manual/discovery/low_level_discovery/graph_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=host.edit&hostid=10084', // ЗАББИКС Сервер.
					'doc_link' => '/en/manual/config/hosts/host#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=item.list&context=host&filter_set=1&filter_hostids[0]=40001&context=host',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=item.edit&context=host&hostid=10084',
					'doc_link' => '/en/manual/config/items/item#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=item.edit&context=host&itemid=42243', // Item => Available memory
					'doc_link' => '/en/manual/config/items/item#configuration'
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=trigger.edit&context=host',
					'doc_link' => '/en/manual/config/triggers/trigger#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=trigger.edit&triggerid=99251&context=host&hostid=10084', // Test trigger with tag.
					'doc_link' => '/en/manual/config/triggers/trigger#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=graph.list&context=host&filter_set=1',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.edit&context=host&hostid=40001',
					'doc_link' => '/en/manual/config/visualization/graphs/custom#configuring-custom-graphs'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.edit&graphid=300000&context=host',
					'doc_link' => '/en/manual/config/visualization/graphs/custom#configuring-custom-graphs'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=item.prototype.list&parent_discoveryid=133800&context=host',
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=item.prototype.edit&parent_discoveryid=133800&context=host',
					'doc_link' => '/en/manual/discovery/low_level_discovery/item_prototypes'
				]
			],
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=item.prototype.edit&itemid=23800&parent_discoveryid=133800&context=host',
					'doc_link' => '/en/manual/discovery/low_level_discovery/item_prototypes'
				]
			],
			...
			[
				[
					// Discovery rule => testFormDiscoveryRule.
					'url' => 'sdnet.php?action=popup&popup=trigger.prototype.edit&parent_discoveryid=133800&context=host',
					'doc_link' => '/en/manual/discovery/low_level_discovery/trigger_prototypes'
				]
			],
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=trigger.prototype.edit&parent_discoveryid=133800&triggerid=99518&context=host',
					'doc_link' => '/en/manual/discovery/low_level_discovery/trigger_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=graph.prototype.list&parent_discoveryid=133800&context=host',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.prototype.edit&context=host&parent_discoveryid=133800',
					'doc_link' => '/en/manual/discovery/low_level_discovery/graph_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=graph.prototype.edit&context=host&parent_discoveryid=133800&graphid=600000',
					'doc_link' => '/en/manual/discovery/low_level_discovery/graph_prototypes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=maintenance.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=maintenance.edit&maintenanceid=4', // Maintenance for suppression test.
					'doc_link' => '/en/manual/maintenance#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&eventsource=0',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=action.edit&actionid=3&eventsource=0',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&eventsource=1',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					...
					'url' => 'sdnet.php?action=popup&popup=action.edit&actionid=2&eventsource=1',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&eventsource=2',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&eventsource=3',
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=action.edit&actionid=4&eventsource=3', // Report not supported items.
					'doc_link' => '/en/manual/config/notifications/action#configuring-an-action'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=correlation.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=discovery.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=discovery.edit&druleid=2', // Discovery rule => Local network.
					'doc_link' => '/en/manual/discovery/network_discovery/rule#rule-attributes'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=audit.settings.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=image.list&imagetype=2',
					'doc_link' => '/en/manual/web_interface/frontend_sections/administration/general#images'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=image.edit&imagetype=1',
					'doc_link' => '/en/manual/web_interface/frontend_sections/administration/general#images'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=image.edit&imageid=2',
					'doc_link' => '/en/manual/web_interface/frontend_sections/administration/general#images'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=iconmap.edit',
					'doc_link' => '/en/manual/web_interface/frontend_sections/administration/general#icon-mapping'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=iconmap.edit&iconmapid=101',
					'doc_link' => '/en/manual/web_interface/frontend_sections/administration/general#icon-mapping'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=regex.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=regex.edit&regexid=3',
					'doc_link' => '/en/manual/regular_expressions#global-regular-expressions'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=geomaps.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=module.list',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=token.edit&admin_mode=1',
					'doc_link' => '/en/manual/web_interface/frontend_sections/users/api_tokens'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=proxy.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=proxygroup.list',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=proxygroup.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=usergroup.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=usergroup.edit&usrgrpid=7',
					'doc_link' => '/en/manual/config/users_and_usergroups/usergroup#configuration'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=userrole.list',
			...
			[
				[
					'url' => '/sdnet.php?action=userrole.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=userrole.edit&roleid=3',
					'doc_link' => '/en/manual/web_interface/frontend_sections/users/user_roles#default-user-roles'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=user.edit&userid=1',
					'doc_link' => '/en/manual/config/users_and_usergroups/user'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=mediatype.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=mediatype.edit&mediatypeid=1', // Email.
					'doc_link' => '/en/manual/config/notifications/media#common-parameters'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=script.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=script.edit&scriptid=1', // Ping.
					'doc_link' => '/en/manual/web_interface/frontend_sections/alerts/scripts#configuring-a-global-script'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=queue.overview.proxy',
			...
			[
				[
					'url' => 'sdnet.php?action=queue.details',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=token.edit&admin_mode=0',
					'doc_link' => '/en/manual/web_interface/frontend_sections/users/api_tokens'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=templategroup.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=templategroup.edit&groupid=12', // Templates/Applications.
					'doc_link' => '/en/manual/config/templates/template#creating-a-template-group'
				]
			],
			...
			[
				[
					'url' => 'sdnet.php?action=connector.list',
			...
			[
				[
					'url' => 'sdnet.php?action=popup&popup=connector.edit',
			...
			[
				[
					'url' => 'sdnet.php?action=timeouts.edit',
