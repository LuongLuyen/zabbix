...
class testPageGraphPrototypes extends testPagePrototypes {
	...
	protected $link = 'sdnet.php?action=graph.prototype.list&context=host&sort=name&sortorder=ASC&parent_discoveryid=';
	...
	public function testPageGraphPrototypes_Sorting($data) {
		$this->page->login()->open('sdnet.php?action=graph.prototype.list&context=host&sort='.$data['sort'].
