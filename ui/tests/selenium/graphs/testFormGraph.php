...
class testFormGraph extends testFormGraphs {
	...
	protected $url = 'sdnet.php?action=graph.list&filter_set=1&filter_hostids%5B0%5D='.self::HOSTID.'&context=host';
	...
	public function testFormGraph_CheckAvailableItems() {
		...
		$url = 'sdnet.php?action=popup&popup=graph.edit&context=host&hostid='.$hostid;
