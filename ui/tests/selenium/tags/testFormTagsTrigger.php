...
class testFormTagsTrigger extends testFormTags {
	...
	public function testFormTagsTrigger_Create($data) {
		...
		$this->link = 'sdnet.php?action=trigger.list&context=host&filter_set=1&filter_hostids%5B0%5D='.$hostid;
	...
	public function testFormTagsTrigger_CopyToHost() {
		$hostid = CDataHelper::get('EntitiesTags.hostids.Host with tags for cloning');
		$this->link = 'sdnet.php?action=trigger.list&filter_set=1&context=host&filter_hostids%5B0%5D='.$hostid;
	...
	public function testFormTagsTrigger_TemplateClone() {
		...
		$this->link = 'sdnet.php?action=trigger.list&filter_set=1&filter_hostids%5B0%5D='.$templateid.'&context=template';
...
//		$templateid = CDataHelper::get('EntitiesTags.templateids.'.$this->template);
//		$this->link = 'sdnet.php?action=trigger.list&filter_set=1&context=template&filter_hostids[0]='.$templateid';
...
//	}
	...
	public function testFormTagsTrigger_InheritedElementTags($data) {
		...
		$hostid = CDataHelper::get('EntitiesTags.hostids.'.$this->host);
		$this->link = 'sdnet.php?action=trigger.list&filter_set=1&context=template&filter_hostids[0]='.$templateid;
		$host_link = 'sdnet.php?action=trigger.list&filter_set=1&context=host&filter_hostids[0]='.$hostid;
